...
<body style=background-color:#fff4ff>
  <nav class="a" aria-label="Sixth navbar example" style="background-color: white;">
    <div class="container-fluid">
      ...
      <b><font face="Comic Sans MS">
        <div class="col-md-10"><i type="button" class="bi bi-chevron-left" style="font-size:40px;" onclick="location.href='./login.php'"></i>&emsp;<href="#" style="color:#DCB3FC; font-size:40px">&emsp;EmoDiary</div></font></b>
      </div>
    </div>
  </nav>
  ...
  <form action="sign_up_input_chk.php" method="post">
    <div class="row">
      ...
      <?php
      if ($_SESSION['error'] != "") {
        echo '<div class="col-md-12 error">';
        echo $_SESSION['error'];
        echo '</div>';
      }
      ?>
