                ...
                <summary>
                      ...
                      <!-- <div id="first">
                        ...
                        <div id="first" class="first">
                          ...
                          <i type="button" id="first1_2" class="visible bi bi-search" style="font-size:25px;" onclick="search.href='login.php'"></i>&emsp;
     ...
     <div id="maindiv" class="container">
        <div class = "row mt-5">
            ...
            <div class="container-fluid">
                ...
                <br>
                <br>
                <h1 class="text-center md-5" style="color:#DCB3FC;">新規登録が完了しました</h1>
                <div class="row">
                  <div class="col-md-12 mt-1 mb-1 alert-danger text-center" id="errorMsg">
                  </div>
              </div>
